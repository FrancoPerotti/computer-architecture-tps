...
\begin{table}[H]
	...
	\begin{tabular}{lcccccc}
		...
		\midrule
		ADD & \texttt{01} & \texttt{01} & \texttt{02} & 0 & 0 & 0 \\
...
\begin{figure}[H]
	\centering
	\physicalcase{img/ADD_01_01.jpeg}{ADD 01 01}\hfill
...
particular, las fotografías permiten observar la diferencia entre
carry y overflow, así como entre los modos de desplazamiento lógico
(SRL) y aritmético (SRA). Además, la carga
