...
Con el comportamiento funcional ya comprobado, comenzó el flujo de
\tech{Vivado}. Primero se elaboraron los esquemáticos y se sintetizó el
diseño para el dispositivo \texttt{xc7a35tcpg236-1} de la placa. % chktex 8
Después se implementaron sus conexiones y se analizaron la utilización
de recursos y los márgenes temporales. El informe presenta la relación
entre el código, las estructuras inferidas por la herramienta y la
evidencia obtenida en las pruebas.
